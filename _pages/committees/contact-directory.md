...
| Contact | Email | Purpose |
|---------|-------|---------|
| **Sponsorship Chairs** | [Laurent Besacier](mailto:laurent.besacier@naverlabs.com), [Yassine Benajiba](mailto:Yassine.benajiba@oracle.com) | Sponsorship inquiries, industry partnerships |

---

## Accommodation & Hotels

| Hotel | Contact | Purpose |
|-------|---------|---------|
...
<style>
  ...
  /* Table styling for contact directory */
  table {
    width: 100%;
    font-size: 14px;
