...
<div class="speaker-container">
  <div class="speaker-photo">
    <img src="/assets/images/speakers/nizar_habash.jpg" alt="Nizar Habash" onerror="this.src='https://placehold.co/150x150?text=Nizar'">
  </div>
  <div class="speaker-info">
    <h3 class="speaker-name">Nizar Habash</h3>
...
<div class="speaker-container">
  <div class="speaker-photo">
    <img src="/assets/images/speakers/marta_costa_jussa.jpg" alt="Marta R. Costa-jussà" onerror="this.src='https://placehold.co/150x150?text=Marta'">
  </div>
  <div class="speaker-info">
    <h3 class="speaker-name">Marta R. Costa-jussà</h3>
...
<div class="speaker-container">
  <div class="speaker-photo">
    <img src="/assets/images/speakers/mariya_toneva.jpg" alt="Mariya Toneva" onerror="this.src='https://placehold.co/150x150?text=Mariya'">
  </div>
  <div class="speaker-info">
    <h3 class="speaker-name">Mariya Toneva</h3>
    
    <div class="speaker-affiliation">Faculty Member, Max Planck Institute for Software Systems</div>

    <div class="talk-details">
      <div class="talk-meta"><strong>Date:</strong> Friday, March 27, 2026 &nbsp; <strong>Time:</strong> 14:00–15:00 &nbsp; <strong>Location:</strong> Salle Le Riad (Level 1)</div>
    ...
    <p>Mariya Toneva is a faculty member at the Max Planck Institute for Software Systems, where she leads the Bridging AI and Neuroscience (BrAIN) group. Her research bridges natural language processing, machine learning, and cognitive neuroscience to develop computational models that deepen our understanding of how the brain processes language and guide the creation of more human-aligned AI systems. Her pioneering work at this intersection has been recognized and supported by the U.S. National Science Foundation (NSF), the German Research Foundation (DFG), and the European Research Council through an ERC Starting Grant.</p>
  </div>
</div>
