...
<h1>EACL 2027</h1>
<h2>Systems Demonstrations Track - Call for Papers</h2>

The EACL 2027 Program Committee invites proposals for the Demonstrations Program. Demonstrations may range from early research prototypes to mature production-ready systems. Publicly available open-source or open-access systems are of special interest. We additionally strongly encourage demonstrations of industrial systems that are technologically innovative, given the current state of the art of theory and applied research in natural language processing.

**Note: Commercial sales and marketing activities are not appropriate in the Demonstration program and should be directed to the EACL 2027 sponsoring program.**

## Areas of interest

We would like to encourage the submission of proposals for demonstrations of software related to any areas of computational linguistics and (applied) natural language processing. Areas of interest include, **but are not limited to:**
...
- Systems that do not necessarily employ LLMs

Papers describing accepted demonstrations will be published in a companion volume of the EACL 2027 conference proceedings. We require at least one of the authors to present a live demo during a demo session at EACL 2027, with an accompanying poster. At least one author of each accepted paper must register for EACL 2027 and present the demo.
...
While comprehensive experimental evaluations are not required, submissions that do not report any form of evidence to validate the prototype's usefulness/quality may be desk-rejected. Acceptable evidence could include: user studies (of any size), automated simulations, benchmark results, expert evaluations, usage statistics, case studies, and qualitative feedback.

Paper submission is electronic, using the **OpenReview conference management system**. The submission site can be found at:

[https://openreview.net/group?id=eacl.org/EACL/2027/Demo](https://openreview.net/group?id=eacl.org/EACL/2027/Demo)
...
- Alexander Hoyle (TU Wien)
- Dimitra Gkatzia (Edinburgh Napier)
- Martha Lewis (ILLC, University of Amsterdam)

Contact: [eacl2027-sysdemo@googlegroups.com](mailto:eacl2027-sysdemo@googlegroups.com)