...
<h1>Call for Papers &ndash; EACL 2027 Student Research Workshop (SRW)</h1>
...
Topics of interest for the SRW are the same as for the main EACL 2027 conference: [https://2027.eacl.org/calls/papers/](https://2027.eacl.org/calls/papers/).
...
* **Pre-submission mentorship deadline**: November 6, 2026  
* **Pre-submission mentorship feedback due**: December 5, 2026  
* **Direct Workshop paper submission deadline**: December 15, 2026  
* **ARR Commitment deadline**: December 22, 2027  
* **Notification of acceptance**: January 5, 2027  
* **Camera-ready papers due**: January 19, 2027  
* **Grant application deadline**: January 21, 2027  
* **Grant application notification**: January 28, 2027  
* **EACL 2027 dates**: March 9–14, 2027
...
We accept both archival submissions (which will be included in the conference proceedings) and non-archival submissions (which will be presented at the workshop but will not be included in the proceedings). Non-archival papers may be submitted to any venue in the future except for another SRW.

Submissions must follow the restrictions of the main conference.
...
For additional submission instructions, please check the ARR [Author Guidelines](https://aclrollingreview.org/authors) and [Frequently Asked Questions](https://aclrollingreview.org/authors#faq). Submissions that do not adhere to the author guidelines or ACL policies will be rejected without review.
...
Students wishing to participate in the pre-submission mentorship must submit their paper draft by November 6, 2026\.

Note that even though the mentoring is not done anonymously, the paper needs to be anonymized. We will check the formality of the paper, including formatting, before we match it with mentors.

The participants will be assigned a mentor who will review and will provide feedback by December 5, 2026\. This mentor will not be the same person who will review the final submission. The feedback will be in the form of guidelines and suggestions to improve the overall writing, which should ideally be incorporated before the actual submission deadline.
...
The submission link for the Pre-submission Mentorship Program is [https://openreview.net/group?id=eacl.org/EACL/2027/SRW\_Pre-submission\_Mentorship](https://openreview.net/group?id=eacl.org/EACL/2027/SRW_Pre-submission_Mentorship)

## **How to submit**

There are two routes for paper submission:

* **Direct Submission**: Papers should be submitted through OpenReview. Each paper will receive a minimum of three reviews. The review process follows the ARR review policy. The submission link is [https://openreview.net/group?id=eacl.org/EACL/2027/SRW](https://openreview.net/group?id=eacl.org/EACL/2027/SRW).  
* **ACL Rolling Review (ARR) Papers**: Papers which have already been reviewed through the ARR system can be committed to the SRW. These papers will not be re-reviewed. Program Chairs will make acceptance decisions based on the ARR reviews and meta-reviews. ARR papers should be committed through OpenReview. When making a new submission, you will be able to specify the details of the ARR paper that you want to commit, including the OpenReview ID of your paper. The deadline for ARR commitment is December 22, 2027, which is well after the EACL main conference notification date (November 12, 2026). Papers rejected at the EACL main conference can be committed to the SRW if they meet the SRW submission requirements.  The commitment site link will be updated closer to the deadline.
...
To apply for a grant, please submit your application by January 21, 2027 (AoE). The notification of grant awards will be sent out by January 28, 2027\. The application link will be provided closer to the deadline.
...
Authors are encouraged to also apply for other schemes of financial support provided by EACL 2027, including Diversity & Inclusion Subsidies and Student Volunteer Grant.

## **Contact Information**

For more information, please follow us on X/Twitter [@eacl\_srw](https://x.com/eacl_srw).  
To contact the organizers of the workshop, please email us at: [eacl2027-srw@googlegroups.com](mailto:eacl2027-srw@googlegroups.com).
