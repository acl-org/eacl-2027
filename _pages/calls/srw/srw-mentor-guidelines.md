---
title: Mentor Guidelines for Student Research Workshop Papers
hide_title: true
layout: single
permalink: /calls/srw/mentor-guidelines/
sidebar:
  nav: calls
toc: true
toc_only: false
...
<nav class="srw-tabbar" role="navigation" aria-label="SRW secondary">
  <ul class="srw-tabs">
    ...
    <li class="active"><a href="{{ '/calls/srw/mentor-guidelines/' | relative_url }}">Mentor Guidelines</a></li>
  </ul>
</nav>
...
1. Log in to your OpenReview account.
2. Navigate to [the "Assigned Submissions" section](https://openreview.net/group?id=eacl.org/EACL/2026/SRW_Mentorship/Reviewers#assigned-submissions).
3. Click on the paper you are mentoring.  
4. Select the **"Official Review"** button to access and submit your feedback.
