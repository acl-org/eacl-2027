...
The ACL Executive Committee has established three registration tiers. Each has an additional fee option for authors presenting papers. These fees cover the direct costs of presentation while keeping attendance more affordable for non-presenting authors and participants.
...
* **≥ 1 month before conference (February 24, 2026):** Full refund less the $50 processing fee.
* **3 weeks before conference (March 2, 2026):** $200 fee, or switch to Virtual (refund = difference in registration fees).
* **2 weeks before conference (March 10, 2026):** No cancellations. Registration can be switched to Virtual (refund = difference in registration fees).
* **No-shows:** No refund.

### Exceptions
* Written requests required with documentation for review and approval by ACL.
* If a visa application is denied, registrants may convert their registration to Virtual Attendance. Refunds will be issued for the difference in cost, provided documentation of the denial is submitted.
